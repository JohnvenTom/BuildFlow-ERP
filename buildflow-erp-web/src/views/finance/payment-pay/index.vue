  ...
  <div class="payment-pay-container">
    ...
    <el-card shadow="never" class="table-card">
      ...
      <el-table :data="tableData" v-loading="loading" border stripe>
        <el-table-column prop="paymentNo" label="付款单号" width="160" show-overflow-tooltip />
        <el-table-column prop="supplierName" label="供应商名称" min-width="160" show-overflow-tooltip />
        <el-table-column prop="paymentAmount" label="付款金额" width="130" show-overflow-tooltip>
...
async function loadPayableOptions(supplierId: number) {
  ...
  payableOptions.value = res.data?.list || []
}
...
async function handleVoid(row: any) {
  await ElMessageBox.confirm(`确定要作废付款单「${row.paymentNo}」吗？`, '作废确认', {
    confirmButtonText: '确定',
    cancelButtonText: '取消',
    type: 'warning'
  })
